...
/* harmony export */   "SocketChannel": () => (/* binding */ SocketChannel)
/* harmony export */ });
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index */ "./dist/index.js");
...
var FAILED_TO_SUBSCRIBE_ERROR = 'Failed to connect to channel, likely due to not being authorised to access this channel.';
var SocketChannel = /*#__PURE__*/function () {
  function SocketChannel(name, client) {
  ...
  _createClass(SocketChannel, [{
    ...
    value: function subscribe(callback) {
      ...
      this.client.emit(_index__WEBPACK_IMPORTED_MODULE_0__.ServerEventTypes.CHANNEL_SUBSCRIBE_REQUEST, {
        channel: this.name
      });
    }
    /**
    ...
    key: "handleSubscriptionResponse",
    value: function handleSubscriptionResponse(data) {
    ...
    key: "dispatchEvent",
    value: function dispatchEvent(packet) {
      if (!this.listeners.has(packet.event)) {
        throw new Error("Received event \"".concat(packet.event, "\" on channel \"").concat(packet.channel, "\", but there is no listener registered."));
      }
    ...
    value: function emit(event, data) {
      if (this.client.getConnectionStatus() !== _index__WEBPACK_IMPORTED_MODULE_0__.ConnectionStatus.CONNECTED) {
    ...
    value: function unsubscribe() {
      this.emit(_index__WEBPACK_IMPORTED_MODULE_0__.ServerEventTypes.CHANNEL_UNSUBSCRIBE_REQUEST, {
        channel: this.name
      });
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index */ "./dist/index.js");
/* harmony import */ var _SocketChannel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SocketChannel */ "./dist/SocketChannel.js");
...
var SocketClient = /*#__PURE__*/function () {
  function SocketClient(url, protocols) {
    ...
    this.connectionStatus = _index__WEBPACK_IMPORTED_MODULE_1__.ConnectionStatus.NONE;
    this.url = url;
  ...
  _createClass(SocketClient, [{
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (this.connectionStatus !== _index__WEBPACK_IMPORTED_MODULE_1__.ConnectionStatus.RE_CONNECTING) {
                  this.connectionStatus = _index__WEBPACK_IMPORTED_MODULE_1__.ConnectionStatus.CONNECTING;
                }
        ...
        _this.ws.addEventListener('message', function (event) {
          ...
          if (packet.event === _index__WEBPACK_IMPORTED_MODULE_1__.ServerEventTypes.SOCKET_READY) {
            ...
            if (_this.channels.size) {
              var _iterator = _createForOfIteratorHelper(_this.channels.values()),
                  _step;
    ...
    value: function subscribe(name, callback) {
      if (this.connectionStatus !== _index__WEBPACK_IMPORTED_MODULE_1__.ConnectionStatus.CONNECTED) {
        throw Error('Cannot subscribe to channel when not connected.');
      }

      var channel = new _SocketChannel__WEBPACK_IMPORTED_MODULE_2__.SocketChannel(name, this);
    ...
    value: function _onMessage(event) {
      ...
      if (packet === null || packet === void 0 ? void 0 : packet.channel) {
        var channel = this.channels.get(packet.channel);
    ...
    key: "handleSubscribeResponse",
    value: function handleSubscribeResponse(data) {
    ...
    value: function removeChannel(channel) {
      var channelName = channel instanceof _SocketChannel__WEBPACK_IMPORTED_MODULE_2__.SocketChannel ? channel.getName() : channel;
    ...
    value: function handleReconnect() {
      if (this.connectionStatus !== _index__WEBPACK_IMPORTED_MODULE_1__.ConnectionStatus.CONNECTED && this.connectionStatus !== _index__WEBPACK_IMPORTED_MODULE_1__.ConnectionStatus.RE_CONNECTING) {
        return false;
      }
...
/* harmony export */   "ServerEventTypes": () => (/* binding */ ServerEventTypes),
/* harmony export */   "SocketChannel": () => (/* reexport safe */ _SocketChannel__WEBPACK_IMPORTED_MODULE_0__.SocketChannel),
/* harmony export */   "SocketClient": () => (/* reexport safe */ _SocketClient__WEBPACK_IMPORTED_MODULE_1__.SocketClient)
/* harmony export */ });
/* harmony import */ var _SocketChannel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SocketChannel */ "./dist/SocketChannel.js");
/* harmony import */ var _SocketClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SocketClient */ "./dist/SocketClient.js");
...
var _require = __webpack_require__(/*! ./../dist */ "./dist/index.js"),
...
function setupSockets() {
  return _setupSockets.apply(this, arguments);
}
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            client.subscribe(publicChannelName, function (error, channel) {
              ...
              userChannel = channel;
              channel.listen('hello', function (data) {
